...
E('MISSING_BOOTSTRAP', '--bootstrap requires a value to override parameters of the bootstrap')
E('MISSING_IP', 'Please include and `IP` address or a list of `IP` addresses. You may include `none` to clear allowed IP list')
E('MISSING_MAGENTO_INIT_PARAMS', '--magneto-init-params requres a value. For example: "MAGE_MODE=developer&MAGE_DIRS[base][path]=/var/www/example.com&MAGE_DIRS[cache][path]=/var/tmp/cache"')
